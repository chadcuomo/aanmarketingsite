      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col px-4 sm:px-6">
        ...
        <div className="relative mt-12 sm:mt-16">
          <BackgroundIllustration
            width="1090"
            height="1090"
            className="absolute -top-7 left-1/2 -z-10 h-[788px] -translate-x-1/2 stroke-gray-100/30 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] sm:-top-9 sm:h-auto"
          />
          <h1 className="text-center text-2xl font-medium tracking-tight text-gray-100">
            {title}
          </h1>
          {subtitle && (
            <p className="mt-3 text-center text-lg text-gray-100">{subtitle}</p>
          )}
        </div>
